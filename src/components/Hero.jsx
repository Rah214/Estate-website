                ...
                <div className='flex md:gap-[32px] justify-center text-center lg:text-left lg:justify-normal '>
                    ...
                    <div className=''>
                        <div className=" lg:flex flex-col hidden max-w-[324px] max-h-[416px] rounded-2xl overflow-hidden shadow-lg bg-white">
                            <Image src={properties[0].image} width={324} height={200} alt="Property" className="w-full rounded-t-2xl"></Image>
                            <div className="pl-[22px] pr-[24px] py-[24px] flex flex-col gap-[4px] max-w-[324px]">
                                <h2 className="text-[24px] font-extrabold text-[#7065F0]">{properties[0].price} <span className='text-[#000929] text-[14px] font-normal opacity-[50%]'>/month</span></h2>
                                <div className='flex flex-col gap-1max-w-[210px]'>
                                    <h3 className="text-xl font-semibold text-gray-800">{properties[0].name}</h3>
                                ...
                                <div className="flex items-center max-w-[208px] justify-between mt-4 text-gray-600">
                                    <div className="flex items-center space-x-1">
                                        <Image src={'/icon1.png'} width={20} height={20} alt='bed'></Image>
                                        <p className='text-[14px]'>{properties[0].beds}</p>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        <Image src={'/icon2.png'} width={20} height={20} alt='bathtub'></Image>
                                        <p className='text-[14px]'>{properties[0].baths}</p>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        <Image src={'/icon3.png'} width={20} height={20} alt='square_foot'></Image>
                    ...
                    {properties.slice(1).map(property => (
                        <div key={property.id} className="max-w-[310px] max-h-[280px] rounded-[8px] p-[1px] overflow-hidden shadow-lg bg-white">
                            ...
                            <div className="pl-[16px] pr-[24px] py-[24px] flex flex-col gap-[4px] max-w-[310px]">
                                <h2 className="text-[16px] leading-6 font-extrabold text-[#7065F0]">{property.price} <span className='text-[#000929] text-[14px] leading-[19.6px] font-normal opacity-[50%]'>/month</span></h2>
                                <div className='flex flex-col gap-1max-w-[210px]'>
                                    <h3 className="text-[16px] leading-6 font-bold text-[#000929]">{property.name}</h3>
                                ...
                                <div className="flex items-center max-w-[208px] justify-between mt-4 text-gray-600">
                                    <div className="flex items-center space-x-1">
                                        <Image src={'/icon1.png'} width={16} height={16} alt='bed'></Image>
                                        <p className='text-[12px] leading-[16.2px]'>{property.beds}</p>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        <Image src={'/icon2.png'} width={16} height={16} alt='bathtub'></Image>
                                        <p className='text-[12px] leading-[16.2px]'>{property.baths}</p>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        <Image src={'/icon3.png'} width={16} height={16} alt='square_foot'></Image>
                                        <p className='text-[12px] leading-[16.2px]'>{property.area}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
